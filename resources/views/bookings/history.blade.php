                                ...
                                <td class="px-6 py-6 text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        @if($booking->status == 'approved' || $booking->status == 'pending')
                                            <form action="{{ route('booking.cancel', $booking->id) }}" method="POST" onsubmit="return confirm('Yakin batalkan?');">
                                                @csrf @method('PATCH')
                                                <button type="submit" class="p-2 rounded-lg text-red-500 hover:bg-red-500 hover:text-white border border-red-200 transition tooltip" title="Batalkan Pesanan">
