        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
                <div class="lg:col-span-7 flex flex-col gap-8">
                    <div class="pb-2">
                        <!-- Judul Besar -->
                        <h1 class="text-6xl font-extrabold text-black tracking-tighter mb-6 leading-none">
                            {{ $event->name }}
                        </h1>
                        ...
                        <div class="flex flex-wrap items-center gap-4">
                            ...
                            <!-- Tanggal Pill -->
                            <div class="flex items-center bg-white border border-[#B8948C]/20 px-4 py-2 rounded-full shadow-sm">
                            ...
                            <!-- Organizer Section -->
                            <div class="flex items-center gap-3 ml-2 pl-4 border-l-2 border-gray-200">
                                ...
                                <div class="flex flex-col justify-center">
                                    ...
                                    <span class="text-sm font-bold text-black leading-tight">{{ $event->organizer->name }}</span>
                                </div>
                            </div>

                        </div>
                    </div>
                    <div class="bg-white p-8 rounded-[2rem] shadow-sm border border-[#B8948C]/10">
                ...
                <div class="lg:col-span-5 flex flex-col gap-8">
                    ...
                    <div class="rounded-[2rem] overflow-hidden shadow-2xl shadow-black/10 border-4 border-white relative group h-[300px] w-full">
                        @if($event->image)
                    ...
                    <div class="bg-white shadow-xl shadow-[#E73812]/5 rounded-[2rem] p-7 border border-[#B8948C]/20 sticky top-28">
