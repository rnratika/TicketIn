        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-end md:items-center mb-6 gap-4">
                <div>
                    ...
                    <p class="text-sm text-[#B8948C]">Kelola dan pantau semua event yang telah Anda buat.</p>
                </div>
                
                <a href="{{ route('organizer.events.create') }}" class="group bg-[#E73812] hover:bg-black text-white text-sm font-bold py-3 px-6 rounded-xl shadow-lg shadow-red-200 hover:shadow-xl transition-all duration-300 flex items-center transform hover:-translate-y-0.5">
